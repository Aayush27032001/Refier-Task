                ...
                <div className="modal-card">
                    <div className="modal-top">
                        <div className="modal-card-title">
                            <p>Login</p>
                            <button onClick={modalHandler} ><i class="fas fa-times fa-lg"></i></button>
                        </div>
                        <div className="modal-google-login">
                    ...
                    <div className="modal-bottom">
                        <div className="sideform-bottom">
                            <div className="form-email-input">
                                <label>Email</label>
                                <input onChange={inputEmailHandler} type="email" placeholder="Email" />
                            </div>
                            <div className="form-password-input">
                                <label>Password</label>
                                <input onChange={inputPasswordHandler} id="password" type="password" placeholder="Password" />
                            </div>
                        </div>
                        <p>Forgot Password?</p>
                        <button className="form-submit-btn" onClick={verifyUser}>Login</button>
                    </div>
                    <div className="modal-signup">
                        New to Refier? Register as <span>Student / Enterprise</span>
                    </div>
                </div>
            </div>
        </div>
